...
public class SampleDataUtil {
    ...
    public static ReadOnlySummonersBook getSampleSummonersBook() {
        ...
        Player[] samplePlayers = getSamplePlayers();

        for (Player samplePlayer : samplePlayers) {
            sampleAb.addPlayer(samplePlayer);
        }

        List<Player> teamRoster = Arrays.asList(Arrays.copyOfRange(samplePlayers, 0, 5));
